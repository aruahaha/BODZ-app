    ...
    <SafeAreaView>
      <View className="py-2 flex-row justify-between items-center px-5 bg-[#ffbe7a]">
        <View>
          <Text
            className=" text-3xl"
            style={{ color: "#191919", fontFamily: "Rubik" }}
          >
            BODZ
          </Text>
        </View>
        <View>
          <View className="">
            <View className="flex-row">
              <Ionicons name="notifications" size={25} color="#191919" />
              <Menu
                w="150"
              ...
              >
                <Menu.Item onPress={() => router.push("/pages/About")}>
                  About
                </Menu.Item>
                <Menu.Item onPress={() => router.push("/pages/Support")}>
                  Support
                </Menu.Item>
